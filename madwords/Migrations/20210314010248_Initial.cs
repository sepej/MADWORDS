    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BlogPostID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BlogPostTitle = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MadwordID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MadwordTitle = table.Column<string>(maxLength: 50, nullable: false),
                    AuthorId = table.Column<string>(nullable: true),
                    MadwordText = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Madwords_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogPostComments", x => x.CommentID);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlogPostComments_AspNetUsers_CommenterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommenterId = table.Column<string>(nullable: true),
                    Reported = table.Column<bool>(nullable: false),
                    MadwordID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comments_Madwords_MadwordID",
                        column: x => x.MadwordID,
                        principalTable: "Madwords",
                        principalColumn: "MadwordID",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_Madwords_MadwordID",
                        column: x => x.MadwordID,
                        principalTable: "Madwords",
                        principalColumn: "MadwordID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPostComments_CommenterId",
                table: "BlogPostComments",
                column: "CommenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_MadwordID",
                table: "Comments",
                column: "MadwordID");

            migrationBuilder.CreateIndex(
                name: "IX_Madwords_AuthorId",
                table: "Madwords",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_MadwordID",
                table: "Ratings",
                column: "MadwordID");
